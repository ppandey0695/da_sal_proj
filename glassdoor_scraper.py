...
def get_jobs(keyword, num_jobs, verbose, path, sleep_time):
    ...
    ##https: // www.glassdoor.com / Job / jobs.htm?suggestCount = 0 & suggestChosen = false & clickSource = searchBtn & typedKeyword = data + analyst & sc.keyword = data + analyst & locT = C & locId = 1147401 & jobType =
